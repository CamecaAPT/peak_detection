...
def _load_detailed_counts(detailed_csv: Path) -> dict[str, int]:
    return unknown_truth_element_molecule_split(pd.read_csv(detailed_csv))
...
def _write_one_summary(dataset_dir: Path, row: pd.Series) -> Path | None:
    ...
    found_true_elements = _count(row.get("elemental_total"))
    found_true_molecules = _count(row.get("molecular_total"))
    correct_elements = _count(row.get("elemental_correct"))
    correct_molecules = _count(row.get("molecular_correct"))
    found_true_elements_exc = _count(row.get("elemental_total_exc"))
    found_true_molecules_exc = _count(row.get("molecular_total_exc"))
    correct_elements_exc = _count(row.get("elemental_correct_exc"))
    correct_molecules_exc = _count(row.get("molecular_correct_exc"))
    ...
    lines = [
        ...
        f"    Predicted / true: {format_ratio(predicted_peaks, true_peaks)}",
        f"  Found peaks: {found_peaks}",
        f"    Found / true: {format_ratio(found_peaks, true_peaks)}",
        f"    Found / predicted: {format_ratio(found_peaks, predicted_peaks)}",
        "",
        "Found peak classification, including unknowns as wrong",
        f"  Found true element peaks: {found_true_elements}",
        f"    Fraction of found peaks: {format_ratio(found_true_elements, found_peaks)}",
        f"  Found true molecule peaks: {found_true_molecules}",
        f"    Fraction of found peaks: {format_ratio(found_true_molecules, found_peaks)}",
        f"  Correct element classifications: {correct_elements}",
        f"    Correct / found true element peaks: {format_ratio(correct_elements, found_true_elements)}",
        f"  Correct molecule classifications: {correct_molecules}",
        f"    Correct / found true molecule peaks: {format_ratio(correct_molecules, found_true_molecules)}",
        "",
        "Found peak classification, excluding unknown predictions",
        f"  Non-unknown found true element peaks: {found_true_elements_exc}",
        f"    Fraction of found non-unknown peaks: {format_ratio(found_true_elements_exc, found_true_elements_exc + found_true_molecules_exc)}",
        f"  Non-unknown found true molecule peaks: {found_true_molecules_exc}",
        f"    Fraction of found non-unknown peaks: {format_ratio(found_true_molecules_exc, found_true_elements_exc + found_true_molecules_exc)}",
        f"  Correct element classifications: {correct_elements_exc}",
        f"    Correct / non-unknown found true element peaks: {format_ratio(correct_elements_exc, found_true_elements_exc)}",
        f"  Correct molecule classifications: {correct_molecules_exc}",
        f"    Correct / non-unknown found true molecule peaks: {format_ratio(correct_molecules_exc, found_true_molecules_exc)}",
        "",
        "Unknown found peaks",
        f"  Unknown peaks with matched truth: {unknown_truth_matched}",
        f"    Fraction of found peaks: {format_ratio(unknown_truth_matched, found_peaks)}",
        f"    Fraction of predicted peaks: {format_ratio(unknown_truth_matched, predicted_peaks)}",
        f"  Unknown true element peaks: {unknown_true_elements}",
        f"    Fraction of found true element peaks: {format_ratio(unknown_true_elements, found_true_elements)}",
        f"  Unknown true molecule peaks: {unknown_true_molecules}",
        f"    Fraction of found true molecule peaks: {format_ratio(unknown_true_molecules, found_true_molecules)}",
        f"  Unknown predicted peaks with no matched truth: {unknown_unmatched}",
        f"    Fraction of predicted peaks: {format_ratio(unknown_unmatched, predicted_peaks)}",
        "",
        "Notes",
